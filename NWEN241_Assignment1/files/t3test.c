...
int main(void)
{
    ...
    printf("Actual   return value: %d\n", ret);
     ...
     printf("----------------------\n");
    strcpy(editing_buffer, "Hello everyone lol");
    printf("Initial  buffer contents: %s\n", editing_buffer);
    printf("Call: editor_replace_str(editing_buffer, 21, \"everyone\", \"nobody.\", 4);\n");
    ret = editor_replace_str(editing_buffer, 21, "everyone", "nobody.", 4);
    strcpy(expected_buffer, "Hello nobody. lol");
    printf("Expected buffer contents: %s\n", expected_buffer);
    printf("Actual   buffer contents: %s\n", editing_buffer);
    printf("Expected return value: 12\n");
    printf("Actual   return value: %d\n", ret);
    
     printf("----------------------\n");
    strcpy(editing_buffer, "Hello nobody!");
    printf("Initial  buffer contents: %s\n", editing_buffer);
    printf("Call: editor_replace_str(editing_buffer, 21, \"nobody!\", \"everyone.\", 4);\n");
    ret = editor_replace_str(editing_buffer, 21, "nobody!", "everyone.", 4);
    strcpy(expected_buffer, "Hello everyone.");
    printf("Expected buffer contents: %s\n", expected_buffer);
    printf("Actual   buffer contents: %s\n", editing_buffer);
    printf("Expected return value: 14\n");
    printf("Actual   return value: %d\n", ret);
    return 0;
}
